...
<table class="main">
  <tr>
	...
	<fieldset>
	<legend><strong><big>Please, submit specific information of game</big></strong></legend>
	<form target="othergm_box" action="insert_othergm.php" method="post">
 		<table>
 			<tr>
				<td>Name</td>
	...
	<iframe name="othergm_box" id="othergm_box" width="100%" height="100" scrolling="auto"></iframe>
	</fieldset>
	</div>
    </td>
  </tr>
